    ...
    <Wrapper py={20}>
      <Container>
        ...
        <Typography variant="h2" component="h3" gutterBottom>
          Developers love Backstage Mickael
        </Typography>
        <Box mb={8} />
        <Grid container spacing={6}>
          <Feature
            ...
            description="Backstage Mickael is built to make your life easier. Theme provider, build tooling, documentation, and 400+ components. "
          />
          <Feature
            Icon={PlusCircleIcon}
