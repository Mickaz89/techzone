  ...
  return (
    <Box mb={10}>
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        ...
        . You'll need to install Node.js (v12 or up) before using Backstage Mickael.
      </Typography>
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        ...
        Backstage Mickael's dependencies. All dependencies will be downloaded to the{" "}
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        ...
        <code>build/</code>
        files. Backstage Mickael is using webpack and webpack-serve to automatically
